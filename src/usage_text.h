...
#define TEXT_BT_EXTERNAL_PORT                                           \
  _(" --bt-external-port=PORT      Specify the external IPv4 TCP BitTorrent peer\n" \
    "                              port. IPv6 keeps using the local listen port.\n" \
    "                              0 uses the local BitTorrent listen port.")
